...
export default function QuinoaScreen() {
    ...
    useEffect(() => {
        const checkFavoriteStatus = async () => {
          ...
          const q = query(recipeRef, where("recipeId", "==", 'Quinoa Salad'));
      ...
      const addToFavorites = async () => {
        try {
          ...
          const recipeData = {
            ...
            image: 'https://firebasestorage.googleapis.com/v0/b/recipeapp-45241.appspot.com/o/QuinoaS.jpg?alt=media&token=951c1148-8ca5-487d-812d-5d1b5cb43071', 
            title: 'Quinoa Salad',
            time: '30 Mins',
          };
    ...
    return (
       <View className="container" style={styles.container}>
        <View >
        <Image source={require('./QuinoaS.jpg')} style={styles.bg}/>
        </View>
        ...
        <View style={styles.details}>
            <Text style={styles.title}>Quinoa Salad</Text>

            <View style={styles.row}>
            <Image source={require('./fire.png')} style={styles.icons}/>
            <Text style={styles.info}>220 CAL</Text>
            ...
            <ScrollView style={{flex: 1}}>
              ...
              <Text style={styles.ing}>1 cup quinoa
              {'\n'}1 red bell pepper,  diced
              {'\n'}1/4 onion, finely chopped
              {'\n'}1/4 cup olive oil</Text>
              </View>

              <View>
              <Text style={styles.subtitle}>Instructions:</Text>
              <Text style={styles.ing}>Rinse quinoa. Cook in boiling water for 15 minutes. Let cool.
              {'\n'}Combine quinoa, cucumber, bell pepper, red onion, tomatoes, and parsley in a large bowl.
              {'\n'}Whisk olive oil, lemon juice, salt, and pepper in a small bowl.
              {'\n'}Pour dressing over salad and toss. Serve chilled or at room temperature</Text>
              </View>
              </ScrollView>
