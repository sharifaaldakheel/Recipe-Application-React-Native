...
export default function LemonBarScreen() {
    ...
    useEffect(() => {
        const checkFavoriteStatus = async () => {
          ...
          const q = query(recipeRef, where("recipeId", "==", 'Lemon Bars'));
      ...
      const addToFavorites = async () => {
        try {
          ...
          const recipeData = {
            recipeId: 'Lemon Bars',
            image: 'https://firebasestorage.googleapis.com/v0/b/recipeapp-45241.appspot.com/o/LemonB.jpg?alt=media&token=91f6070f-91dd-4bb2-af76-e481d7ad1e94', 
            title: 'Lemon Bars',
            time: '45 Mins',
          };
    ...
    return (
       <View className="container" style={styles.container}>
        <View >
        <Image source={require('./LemonB.jpg')} style={styles.bg}/>
        </View>
        ...
        <View style={styles.details}>
            <Text style={styles.title}>Lemon Bars</Text>
            ...
            <ScrollView style={{flex: 1}}>
              ...
              <Text style={styles.ing}>1 cup all-purpose flour
              {'\n'}1/2 cup unsalted butter, softened
              {'\n'}1 1/2 cups granulated sugar
              {'\n'}4 large eggs
              {'\n'}1/2 cup fresh lemon juice
              {'\n'}Zest of 1 lemon
              {'\n'}Powdered sugar, for dustingr</Text>
              </View>
              ...
              {'\n'}Cool completely, dust with powdered sugar, and cut into bars.</Text>
              </View>
              </ScrollView>
