...
export default function PuddingScreen() {
    ...
    useEffect(() => {
        const checkFavoriteStatus = async () => {
          ...
          const q = query(recipeRef, where("recipeId", "==", 'Mango Pudding'));
      ...
      const addToFavorites = async () => {
        try {
          const recipeRef = collection(FIREBASE_DB, "users", userId, "favorites");
          const recipeData = {
            recipeId: 'Mango Pudding',
            image: 'https://firebasestorage.googleapis.com/v0/b/recipeapp-45241.appspot.com/o/pudding.jpg?alt=media&token=3bad1fd6-c954-47e5-8d65-05c8d0d358f1', 
            title: 'Mango Puddings',
            time: '2 H',
          };
