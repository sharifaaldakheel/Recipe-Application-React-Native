...
export default function GrilledChickenScreen() {
    ...
    useEffect(() => {
        const checkFavoriteStatus = async () => {
          ...
          const q = query(recipeRef, where("recipeId", "==", 'Grilled Chicken'));
      ...
      const addToFavorites = async () => {
        try {
          ...
          const recipeData = {
            ...
            image: 'https://firebasestorage.googleapis.com/v0/b/recipeapp-45241.appspot.com/o/GrilledChicken.jpg?alt=media&token=d8d11469-dca5-4483-85e2-898d9120f3d2', 
    ...
    return (
       <View className="container" style={styles.container}>
        <View >
        <Image source={require('./GrilledChicken.jpg')} style={styles.bg}/>
        </View>
        ...
        <View style={styles.details}>
            <Text style={styles.title}>Grilled Chicken Breast</Text>

            <View style={styles.row}>
            <Image source={require('./fire.png')} style={styles.icons}/>
            <Text style={styles.info}>280  CAL</Text>
            ...
            <ScrollView style={{flex: 1}}>
              ...
              <Text style={styles.ing}>Rub chicken with olive oil, garlic powder, paprika, salt, and pepper.
              {'\n'}Grill on medium heat for 6-7 minutes per side until cooked through.</Text>
              </View>
              </ScrollView>
