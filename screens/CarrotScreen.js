...
export default function CarrotScreen() {
    ...
    useEffect(() => {
        const checkFavoriteStatus = async () => {
          ...
          const q = query(recipeRef, where("recipeId", "==", 'Carrot'));
      ...
      const addToFavorites = async () => {
        try {
          ...
          const recipeData = {
            recipeId: 'Carrot',
            image: 'https://firebasestorage.googleapis.com/v0/b/recipeapp-45241.appspot.com/o/CarrotCake.jpg?alt=media&token=84b20472-3603-4080-9364-10cf7fc38ac1', 
            title: 'Carrot Cake',
            time: '10 Minutes',
          };
    ...
    return (
       <View className="container" style={styles.container}>
        <View >
        <Image source={require('./CarrotCake.jpg')} style={styles.bg}/>
        </View>
        ...
        <View style={styles.details}>
            <Text style={styles.title}>Carrot Cake</Text>
            ...
            <ScrollView style={{flex: 1}}>
              ...
              <Text style={styles.ing}>2 cups grated carrots
              {'\n'}1 cup flour
              {'\n'}1/2 cup brown sugar and vegetable oil
              {'\n'}2 eggs
              {'\n'}1 tsp vanilla extract
              {'\n'}1/2 tsp baking powder and  baking soda
              {'\n'}1/4 tsp nutmeg, salt, and cinnamon</Text>
              </View>
              ...
              {'\n'}Mix all Ingredients
              {'\n'}Bake 30-35 minutes. Cool 10 minutes.
              {'\n'}For frosting, beat cream cheese and butter until smooth.
              {'\n'}Frost cooled cake.</Text>
              </View>
              </ScrollView>
