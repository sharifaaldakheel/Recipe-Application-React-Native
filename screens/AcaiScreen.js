...
export default function AcaiScreen() {
    ...
    useEffect(() => {
        const checkFavoriteStatus = async () => {
          ...
          const q = query(recipeRef, where("recipeId", "==", 'Acai Bowl'));
      ...
      const addToFavorites = async () => {
        try {
          ...
          const recipeData = {
            recipeId: 'Acai Bowl',
            image: 'https://firebasestorage.googleapis.com/v0/b/recipeapp-45241.appspot.com/o/acai.jpg?alt=media&token=c0075932-c894-49b6-bcd8-a595dbeeddc0', 
            title: 'Acai Bowl',
            time: '15 Minutes',
          };
    ...
    return (
       <View className="container" style={styles.container}>
        <View >
        <Image source={require('./acai.jpg')} style={styles.bg}/>
        </View>
        ...
        <View style={styles.details}>
            <Text style={styles.title}>Acai Bowl</Text>
            ...
            <ScrollView style={{flex: 1}}>
              ...
              <Text style={styles.ing}>2 packs of frozen acai puree{'\n'}1/2 cup of almond milk or any milk of your choice{'\n'}
              1 ripe banana{'\n'}Toppings of your choice(granola, sliced fruits, shredded coconut, nuts, etc.)</Text>
              </View>

              <View>
              <Text style={styles.subtitle}>Instructions:</Text>
              <Text style={styles.ing}>Break the frozen acai packs into smaller pieces and blend them with the almond milk and banana until smooth.
