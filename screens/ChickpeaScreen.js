...
export default function ChickpeaScreen() {
    ...
    useEffect(() => {
        const checkFavoriteStatus = async () => {
          ...
          const q = query(recipeRef, where("recipeId", "==", 'Chickpea Salad'));
      ...
      const addToFavorites = async () => {
        try {
          const recipeRef = collection(FIREBASE_DB, "users", userId, "favorites");
          const recipeData = {
            recipeId: 'Chickpea Salad',
            image: 'https://firebasestorage.googleapis.com/v0/b/recipeapp-45241.appspot.com/o/Chickpea.jpg?alt=media&token=23100415-ff2e-47c1-ac9a-5b15d523aac8', 
