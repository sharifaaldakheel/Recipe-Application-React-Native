...
export default function BakedSalmonScreen() {
    ...
    useEffect(() => {
        const checkFavoriteStatus = async () => {
          ...
          const q = query(recipeRef, where("recipeId", "==", 'Baked Salmon'));
      ...
      const addToFavorites = async () => {
        try {
          ...
          const recipeData = {
            ...
            image: 'https://firebasestorage.googleapis.com/v0/b/recipeapp-45241.appspot.com/o/BakedSalmon.jpg?alt=media&token=489c6a18-35ed-4754-82a9-1c0b52c2a314', 
            title: 'Baked Salmon',
            time: '25 Minutes',
          };
    ...
    return (
       <View className="container" style={styles.container}>
        <View >
        <Image source={require('./BakedSalmon.jpg')} style={styles.bg}/>
        </View>
        ...
        <View style={styles.details}>
            <Text style={styles.title}>Baked Salmon</Text>

            <View style={styles.row}>
            <Image source={require('./fire.png')} style={styles.icons}/>
            <Text style={styles.info}>400  CAL</Text>
            <Image source={require('./clock.png')} style={styles.icons}/>
            <Text style={styles.info}>25 Minutes</Text>
            </View>

            <ScrollView style={{flex: 1}}>
              <View>
              <Text style={styles.subtitle}>Ingredients:</Text>
              <Text style={styles.ing}>4 salmon fillets
              {'\n'}2 tbsp olive oil
              {'\n'}1 lemon, sliced
              {'\n'}1 tsp dried dill
              ...
              <Text style={styles.ing}>Preheat oven to 400°F (200°C).
              {'\n'}Place salmon on a baking sheet, drizzle with olive oil, and season with dill, salt, and pepper.
              {'\n'}Top with lemon slices and bake for 15-20 minutes.</Text>
              </View>
              </ScrollView>
