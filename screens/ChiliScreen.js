...
export default function ChiliScreen() {
    ...
    useEffect(() => {
        const checkFavoriteStatus = async () => {
          ...
          const q = query(recipeRef, where("recipeId", "==", 'Vegetarian Chili'));
      ...
      const addToFavorites = async () => {
        try {
          const recipeRef = collection(FIREBASE_DB, "users", userId, "favorites");
          const recipeData = {
            recipeId: 'Vegetarian Chili',
            image: 'https://firebasestorage.googleapis.com/v0/b/recipeapp-45241.appspot.com/o/vegetarian-chili.jpg?alt=media&token=3ab153c2-419f-4daa-84a2-39fcaa5a213a', 
    ...
    return (
       <View className="container" style={styles.container}>
        <View >
        <Image source={require('./vegetarian-chili.jpg')} style={styles.bg}/>
        </View>
        ...
        <View style={styles.details}>
            <Text style={styles.title}>Vegetarian Chili</Text>
            ...
            <ScrollView style={{flex: 1}}>
              ...
              <Text style={styles.ing}>1 can black beans{'\n'}1 candiced tomatoes{'\n'}1 onion, chopped{'\n'}
                1 bell pepper, chopped{'\n'}2 cloves garlic, minced</Text>
              </View>

              <View>
              <Text style={styles.subtitle}>Instructions:</Text>
              <Text style={styles.ing}>Bell pepper, onion and garlic until soft.{'\n'}Add beans, tomatoes, chili powder, and cumin.{'\n'}Simmer for 15-20 minutes.
